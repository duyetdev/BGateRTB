        ...
        public BiddingAgent
{
    ...
    void init(const std::shared_ptr<ApplicationLayer> appLayer)
    {
        ...
        onBidRequest = bind(
                &BGateBiddingAgent::bid, this, _1, _2, _3, _4, _5, _6);
        ...
        addPeriodic("BGateBiddingAgent::pace", 10.0,
                [&] (uint64_t) { this->pace(); });
    ...
    void setConfig()
    {
        ...
        // TODO: fetch list account here
        config.account = {"hello", "world", "lvduit"};

        // Specify the properties of the creatives we are trying to show.
        // TODO: fetch all creative that BGate support
        config.creatives.push_back(Creative::sampleLB); cout << Creative::sampleLB << endl;
        config.creatives.push_back(Creative::sampleWS); cout << Creative::sampleWS << endl;
        config.creatives.push_back(Creative::sampleBB); cout << Creative::sampleBB << endl;
...
int main(int argc, char** argv)
{
    ...
    RTBKIT::BGateBiddingAgent agent(serviceProxies, "fixed-price-agent-ex");
