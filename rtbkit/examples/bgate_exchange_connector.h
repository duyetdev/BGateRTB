...
struct BgateExchangeConnector : public HttpExchangeConnector {
    BgateExchangeConnector(ServiceBase & owner, const std::string & name) :
    ...
    BgateExchangeConnector(const std::string & name, std::shared_ptr<ServiceProxies> proxies) :
