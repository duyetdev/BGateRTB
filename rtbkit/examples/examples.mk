...
$(eval $(call library,bgate_exchange,bgate_exchange_connector.cc,exchange))
...
$(eval $(call program,bidding_agent_bgate,bidding_agent rtb_router boost_program_options services))
