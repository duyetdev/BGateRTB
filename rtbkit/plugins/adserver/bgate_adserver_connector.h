...
struct BgateAdServerConnector : public HttpAdServerConnector
{
    BgateAdServerConnector(const std::string& serviceName,
    ...
    BgateAdServerConnector(Datacratic::ServiceProxyArguments & args,
                          const std::string& serviceName)
        : HttpAdServerConnector(serviceName, args.makeServiceProxies()),
          publisher(getServices()->zmqContext) {
    }

    BgateAdServerConnector(std::string const & serviceName, std::shared_ptr<ServiceProxies> const & proxies,
